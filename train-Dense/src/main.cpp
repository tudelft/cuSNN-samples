...
int main(int argc, char** argv){
  ...
  // dataset
    ...
    SNN->add_layer("Conv2d", false, true, true, 0.4f, 5.f, 0.15f, 25.f, 10, 0.5f, 5, 64, "half");
    SNN->add_layer("Pooling", false, false, false, 0.000001f, 5.f, 1.f, 1.f, 1, 0.f, 8);
    SNN->add_layer("Dense", true, false, true, 0.4f, 5.f, 0.15f, 1.f, 1, 0.f, 5, 32);
