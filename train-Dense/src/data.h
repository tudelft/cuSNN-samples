...
void feed_network(const std::string& dataset_dir, std::vector<std::string>& dataset, float sim_int, float sim_step,
                  int sim_num_steps, float scale_ets, Network *&SNN, plotterGL *plotter, bool openGL,
                  bool data_augmentation, bool record_activity, std::string snapshots_dir, std::string weights_out,
                  bool random, bool& break_sim);
