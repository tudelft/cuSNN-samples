...
int main(int argc, char** argv){
  ...
  // dataset
    const std::string dataset_dir = "../data/disk";
    const int inp_size[] = {2, 180, 240}; // (channels, height, width)
    const float inp_scale[] = {2.f, 2.f}; // (height, width)

    // simulation settings
    const int runs = 1;
    const float sim_time = -1.f; // ms
    ...
    SNN->add_layer("Conv2d", false, true, true, 0.3f, 5.f, 0.1f, 1.f, 1, 0.f, 5, 32, "half");
    SNN->add_layer("Merge", false, true, false, 0.000001f, 5.f, 1.f);
    SNN->add_layer("Conv2d", false, true, true, 0.3f, 30.f, 0.1f, 200.f, 10, 0.5f, 5, 64, "half");
    SNN->add_layer("Pooling", false, true, false, 0.000001f, 5.f, 1.f, 1.f, 1, 0.f, 6);
    SNN->add_layer("Dense", false, true, true, 0.3f, 30.f, 0.1f, 1.f, 1, 0.f, 5, 16);
